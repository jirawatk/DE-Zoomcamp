...
URL_TEMPLATE = f"https://s3.amazonaws.com/nyc-tlc/misc/taxi+_zone_lookup.csv"
OUTPUT_TEMPLATE = f"{AIRFLOW_HOME}/{dataset_file}"
...
with DAG(
    dag_id="data_zone_ingestion_gcs_dag",
